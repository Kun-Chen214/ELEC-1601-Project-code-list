...
void loop()
{
    ...
    {        
        ...
        if (buttonPressed == false) {
          if(xPosition > 515 && xPosition < 530 && yPosition > 510 && yPosition < 520) {
            blueToothSerial.println('s'); // Stop
          }
          else if(xPosition == 0) {
            blueToothSerial.println('l');
          }
          else if(xPosition >= 1015) {
            blueToothSerial.println('r');
        }

          else if(yPosition >= 1015) { // Forward
