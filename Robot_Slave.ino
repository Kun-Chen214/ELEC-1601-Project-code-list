...
void loop()
{
    ...
    while(1)
    {
        ...
        {
//            if (lineTracking == true && buttonCount == 2) {
//            // Memory
//            servoLeft.attach(13);
//            servoRight.attach(12);
//            i = counter;
//            while (i >= 0) {
//               servoLeft.writeMicroseconds(leftNum[i]);
//                servoRight.writeMicroseconds(rightNum[i]);
//               delay(100);
//              i -= 1;
//            }
//          }
...
//              leftNum[counter] = 1300;
//              rightNum[counter] = 1400;
...
//              leftNum[counter] = 1600;
//              rightNum[counter] = 1700;
////              duration[counter] = 100;
//              counter += 1;
              }
              else if (recvChar == 'f') {
...
//              leftNum[counter] = 1700;
//              rightNum[counter] = 1300;
////              duration[counter] = 100;
//              counter += 1;
              } else if (recvChar == 'b') {
                lineTracking = true;
